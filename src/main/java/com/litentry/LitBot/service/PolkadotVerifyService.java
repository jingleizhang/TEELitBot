package com.litentry.LitBot.service;

import com.alibaba.fastjson.JSONObject;
import com.litentry.LitBot.config.BotProperties;
import com.litentry.LitBot.polkadot.SS58.SS58Type;
import com.litentry.LitBot.polkadot.common.Address;
import com.litentry.LitBot.utils.AES256;
import com.litentry.LitBot.utils.BotUtils;
import com.litentry.LitBot.utils.HttpUtils;
...
public class PolkadotVerifyService {
            ...
            if (result != null) {
                ...
                if (isValid) {
                    ...
                    if (roleId.longValue() > 0L && channelId.longValue() > 0L) {
                        //log.debug("start addRoleAndChannel {} {} {} {}", guildId, discordUid, roleId, channelId);
    ...
    //        log.debug("got query result {} data {} API {}", result.toJSONString(), data.toJSONString(), crowdloanContributorApi);
    //
    //        if (result != null) {
