package com.litentry.LitBot.polkadot.common;

import com.litentry.LitBot.polkadot.SS58.*;
...
public class Address implements Comparable<Address> {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(pubkey, address.pubkey) && Objects.equals(network, address.network);
    }
    ...
    //        log.info("SUBSTRATE network: {}", address.network == SS58Type.Network.SUBSTRATE);
    //
    //        String pubkey = Hex.encodeHexString(address.pubkey);
    //        log.info("pubkey: 0x{}", pubkey);
    //
    //        //POLKADOT
    //        Address polkaAddr = new Address(SS58Type.Network.POLKADOT, Hex.decodeHex(pubkey));
    //        log.info("POLKADOT Addr: 0x{}", polkaAddr.toString());
    //    }
}
