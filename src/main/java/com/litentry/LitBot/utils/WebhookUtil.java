package com.litentry.LitBot.utils;
...
public class WebhookUtil {
    ...
    public void sendWebhook(Member owner, Guild guild, Action action) {
            ...
            case JOIN:
                ...
                embed =
                    new WebhookEmbedBuilder()
                        ...
                        .addField(new WebhookEmbed.EmbedField(false, "Name", guild.getName()))
                        .addField(new WebhookEmbed.EmbedField(false, "ID", guild.getId()))
                        .addField(new WebhookEmbed.EmbedField(false, "Owner", String.format("%s | %s ", name, id)))
                        .addField(
                        ...
                        .setFooter(new WebhookEmbed.EmbedFooter(String.format("Guild #%d", guild.getJDA().getGuildCache().size()), null))
        ...
        this.sendMsg(guild.getSelfMember().getUser().getEffectiveAvatarUrl(), title, null, embed);
    }
