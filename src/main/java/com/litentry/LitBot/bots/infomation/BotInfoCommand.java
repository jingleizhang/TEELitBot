package com.litentry.LitBot.bots.infomation;

import com.litentry.LitBot.command.CommandCategory;
import com.litentry.LitBot.command.CommandContext;
import com.litentry.LitBot.command.ICommand;
import com.litentry.LitBot.config.BotProperties;
import com.litentry.LitBot.config.Constants;
import com.litentry.LitBot.utils.MiscUtils;
...
public class BotInfoCommand extends ICommand {
    ...
    public BotInfoCommand(BotProperties botProperties) {
        this.name = "botinfo";
    ...
    public void handle(@NotNull CommandContext ctx) {
        ...
        EmbedBuilder eb = EmbedUtils
            ...
            //            .addField(
            //                "LIBRARY:",
            //                "[JDA " + JDAInfo.VERSION + "](http://home.dv8tion.net:8080/job/JDA/" + JDAInfo.VERSION_BUILD + "/)",
            //                true
            //            )
    ...
    private String getProcessCpuLoad() {
        ...
        try {
            list = mbs.getAttributes(ObjectName.getInstance("java.lang:type=OperatingSystem"), new String[] { "ProcessCpuLoad" });
        } catch (Exception e) {
            //log.error("ProcessCpuLoad exception:", e);
        }
